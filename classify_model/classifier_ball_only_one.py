...
def generate_hands_data(train_data_list):
    ...
    for i_0 in range(len(cls_0)):
        cls_0_txt_path = f"/home/chaoen/yoloNhit_calvin/FastInst-main/output/new_record/right_handed/new_weight/{cls_0_txt[i_0]}"
        f_0 = open(cls_0_txt_path, "r")
        data_0 = f_0.read()
        data_0_paddle_list = data_0.split(",")
        f_0.close()
...
# print(model)
model.load_state_dict(torch.load('model_0625_hands.pth'))
