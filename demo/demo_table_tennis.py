...
def get_parser():
    parser = argparse.ArgumentParser(description="fastinst demo for builtin configs")
    parser.add_argument(
        "--config-file",
        default="configs/coco/instance-segmentation/fastinst_R50_ppm-fpn_x1_576.yaml",
        metavar="FILE",
