...
_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "table_tennis_train_panoptic": (
        # This is the original panoptic annotation directory
        "table_tennis/panoptic_train",
        "table_tennis/annotations/panoptic_train.json",
        # This directory contains semantic annotations that are
        # converted from panoptic annotations.
        # It is used by PanopticFPN.
        # You can use the script at detectron2/datasets/prepare_panoptic_fpn.py
        # to create these directories.
        "table_tennis/panoptic_semseg_train",
    ),
    "table_tennis_val_panoptic": (
        "table_tennis/panoptic_val",
        "table_tennis/annotations/panoptic_val.json",
        "table_tennis/panoptic_semseg_val",
    ),
}
...
def get_metadata():
    ...
    stuff_classes = [k["name"] for k in TABLE_TENNIS_CATEGORIES]
    stuff_colors = [k["color"] for k in TABLE_TENNIS_CATEGORIES]
    ...
    for i, cat in enumerate(TABLE_TENNIS_CATEGORIES):
        if cat["isthing"]:
