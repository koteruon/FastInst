...
output_video = cv2.VideoWriter('/home/chenzy/FastInst-main/mediapipe/new_record/left/fhpull_left_1_crop_gesture.mp4', codec, fps, (int(width), height),isColor=True)
