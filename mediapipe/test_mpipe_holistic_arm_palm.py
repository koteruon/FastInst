...
def is_landmark_in_connection(connection, landmark):
    return landmark.value not in connection and not (
        mp_holistic.PoseLandmark.LEFT_SHOULDER in connection and mp_holistic.PoseLandmark.RIGHT_SHOULDER in connection
    )
...
def detect_right_hand(input_video, output_path):
    ...
    # output_video = cv2.VideoWriter(output_path + "_test_0710.mp4", codec, fps, (int(width), height),isColor=True)
    # print(fps, width, height)
    lndmark_list = []
    proceed_frame = 0

    with mp_holistic.Holistic(
        model_complexity=2, min_detection_confidence=0.15, min_tracking_confidence=0.15
    ) as holistic:
            ...
            if not ret:
                ...
                if results.pose_landmarks:
                    lndmark_list.append(
                        [
                            [
                                results.pose_landmarks.landmark[i.value].x,
                                results.pose_landmarks.landmark[i.value].y,
                                results.pose_landmarks.landmark[i.value].z,
                            ]
...
detect_right_hand(
    r"/home/chaoen/yoloNhit_calvin/FastInst-main/2024niag_C00820401.mp4",
    r"/home/chaoen/yoloNhit_calvin/FastInst-main/mediapipe/new_record/left/right_handed/0710/2024niag_C00820401",
)
# detect_right_hand(r'/home/chenzy/FastInst-main/new_record/left_player/right/bhc_left_1_crop.mp4',r'/home/chenzy/FastInst-main/mediapipe/new_record/left/right_handed/test_0710/bhc_left_1_crop')
